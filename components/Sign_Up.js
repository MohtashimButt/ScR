  ...
  render() {
    return (
        <>
            ...
            <View style={tw`w-full h-1/3 rounded-br-3xl bg-white items-center justify-center`}>
                <Text>LOGO</Text>
            </View>
            <View style={tw`flex-col py-10 px-5 items-center border-red-500 w-full h-2/3 bg-black rounded-tl-3xl`}>
